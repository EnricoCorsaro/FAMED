function compute_ash,parameter,distribution,n_bins
 ; -------------------------------------------------------------------------------------------------------
 ; Author:  Enrico Corsaro
 ; e-mail:  enrico.corsaro@inaf.it
 ; Date:    August 2019
 ; Place:   Catania, Italy
 ; Purpose: This function computes an Averaged Shifted Histogram (ASH) from an input sampling distribution.
 ;          It requires that the number of bins of the distribution is provided as input.
 ; -------------------------------------------------------------------------------------------------------
